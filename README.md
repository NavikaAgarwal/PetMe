...
### How to contribute?
- Take a look at the existing [Issues](https://github.com/NavikaAgarwal/PetMe/issues) or [create a new issue](https://github.com/NavikaAgarwal/PetMe/issues/new/choose)!
...
- Create a **[Pull Request](https://github.com/NavikaAgarwal/PetMe/compare)** (_PR_), which will be promptly reviewed and given suggestions for improvements by the community.
- Add screenshots or screen captures to your Pull Request to help us understand the effects of the changes proposed in your PR.
- **DON'T CREATE PRs WITHOUT CREATING ISSUE AND GETTING ASSIGNED**

### How to make a pull request (PR)?
**1.** Start by making a Fork of the [**PetMe**](https://github.com/NavikaAgarwal/PetMe/) repository. Click on the <a href="https://github.com/NavikaAgarwal/PetMe/fork"><img src="https://i.imgur.com/G4z1kEe.png" height="21" width="21"></a>Fork symbol at the top right corner.
